...
public class TradeHistory {
	...
	public TradeHistory(int portfolioId, String symbol, int shares, BigDecimal price, BigDecimal commission, long timeOfTrade ) {
		this.portfolioId = portfolioId;
		this.symbol = symbol;
		this.shares = shares;
		this.price = price;
		this.commission = commission;
		this.notional = price.multiply(new BigDecimal(shares).setScale(2, BigDecimal.ROUND_HALF_EVEN));
